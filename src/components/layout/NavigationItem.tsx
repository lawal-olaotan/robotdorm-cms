...
const NavigationItem = ({ name, href }: NavigationItemProps) => {
  return (
    <Link
      className="flex items-center justify-between text-base sm:font-bold lg:font-normal text-center px-6 py-2 lg:hover:font-bold  sm:hover:bg-sky-100 hover:text-primary sm:mb-8 lg:mb-0"
      href={href}
    >
      {name}
    </Link>
